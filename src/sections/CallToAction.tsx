    ...
    <section ref={sectionRef} className='py-20 md:py-24'>
      <div className='container'>
        <motion.div
          ...
          <motion.div className='absolute inset-0 bg-[rgb(74,32,138)] bg-blend-overlay [mask-image:radial-gradient(50%_50%_at_0px_0px,black,transparent)] opacity-0 group-hover:opacity-100 transition duration-700' style={{
            maskImage,
            backgroundImage: `url(${gridLines.src})`
          }}/>
